...
HATS: List[Dict[str, Any]] = [
    _hat("hat_red_cap", "Classic Red Cap", 250, [
        {"t": "box", "p": [0, 0.28, 0], "s": [1.55, 0.55, 1.55], "c": "#5a2d22"},
        {"t": "box", "p": [0, 0.09, 0.95], "s": [1.5, 0.16, 0.8], "c": "#c4281c"},
        {"t": "box", "p": [0, 0.56, 0], "s": [0.34, 0.16, 0.34], "c": "#c4281c"},
        {"t": "box", "p": [0, 0.3, 0.79], "s": [0.5, 0.42, 0.06], "c": "#f2f3f3",
         "decal": "letter_R"},
